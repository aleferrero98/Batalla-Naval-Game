...
public class PanelLogin extends JPanel {
	...
	public PanelLogin() {
		...
		JPanel avatar1 = new PanelAvatar(new ImageIcon(getClass().getResource("/imagenes/flash.jpg")));
		JPanel avatar2 = new PanelAvatar(new ImageIcon(getClass().getResource("/imagenes/batman.jpg")));
		JPanel avatar3 = new PanelAvatar(new ImageIcon(getClass().getResource("/imagenes/spiderman.jpg")));
	...
	public void paintComponent(Graphics g) {
		...
		ImageIcon imagen=new ImageIcon(getClass().getResource("/imagenes/batallanaval4.jpg"));
